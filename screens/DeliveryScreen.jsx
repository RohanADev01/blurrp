    ...
    <View className='flex-1'>
      ...
      <View className='rounded-t-3xl -mt-12 bg-white relative'>
        <View className='flex-row justify-between px-5 pt-10'>
          ...
          <Image className='w-24 h-24' source={require('../assets/images/deliveryGuy.png')} />
        </View>
        <View style={{ backgroundColor: themeColors.bgColor(0.8) }} className='p-2 flex-row justify-between rounded-full my-5 mx-2'>
